...
let descricaoNivel_Nivel = []

let porcentagemAcerto_Nivel = []



let botao_criar_Nivel = document.querySelector(".terceiraParte .botaoNivel")
function info_basica_Nivel() {
    ...
    porcentagemAcerto = document.querySelectorAll(".terceiraParte .descricaoNivel")
    ...
    /*try {let url = new URL(url_niveis[i])       
             } catch(err) {
            alert("A URL da imagem esta incorreta")
            return 'testte'
            }
            if(parametro1 && parametro2 && parametro3 && parametro4){
                console.log(titulo_list)
                console.log(url_niveis)
            }*/
    ...
    /*for(let i = 0; i < quantidadeNivel; i++){
     ...
     console.log('clikou')
     titulo = document.querySelector(".terceiraParte").querySelector(".tituloNivel").value
     titulo_list.push(titulo)       
     url_niveis.push(document.querySelector(".terceiraParte").querySelector(".urlNivel").value)   
     descricaoNivel_Nivel.push(document.querySelector(".terceiraParte").querySelector(".descricaoNivel").value)
     porcentagemAcerto_Nivel.push(document.querySelector(".terceiraParte").querySelector(".porcentagemAcerto").value)
 
     if(titulo_list[i].length < 20 || descricaoNivel_Nivel[i] < 30 || porcentagemAcerto_Nivel[i] < 0){
         alert("preencher os dados corretamente.")
         parametro1 = 1
         return 'testte'
      }else{
     ...
     try {      let url = new URL(url_niveis[i])        } catch(err) {
         alert("A URL da imagem esta incorreta")
         return 'testte'
         }
     }
